...
const MobileSideBar = ({setShowSideBar}:{setShowSideBar:React.Dispatch<React.SetStateAction<boolean>>}) => {
    return (
        <div className='transition-all w-10/12 duration-300 text-white fixed z-10 h-screen bg-gradient-to-r from-[#4285F4] to-[#3C83F9] laptop:hidden flex-col justify-between flex px-10 py-5'>
            <div>
